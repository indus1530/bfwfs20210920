...
*//*
    ...
    public void onSyncDataClick(View view) {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            startActivity(new Intent(this, edu.aku.hassannaqvi.foodfortificationsurvey.ui.SyncActivity.class).putExtra("login", true));
        } else {
    ...
    public void attemptLogin(View view) {
        ...
        if (attemptCounter == 7) {
            ...
            if ((username.equals("dmu@aku") && password.equals("aku?dmu"))
                ...
                Toast.makeText(edu.aku.hassannaqvi.foodfortificationsurvey.ui.LoginActivity.this, username + " " + password, Toast.LENGTH_SHORT).show();
            }
