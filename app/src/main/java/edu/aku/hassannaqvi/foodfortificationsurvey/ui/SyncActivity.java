...
import static edu.aku.hassannaqvi.foodfortificationsurvey.core.MainApp.sdDir;
import static edu.aku.hassannaqvi.foodfortificationsurvey.core.MainApp.uploadData;
import static edu.aku.hassannaqvi.foodfortificationsurvey.utils.AndroidUtilityKt.isNetworkConnected;
...
import edu.aku.hassannaqvi.foodfortificationsurvey.databinding.ActivitySyncBinding;
import edu.aku.hassannaqvi.foodfortificationsurvey.models.SyncModel;
        ...
        if (sdDir.exists()) {
            ...
            if (files.length > 0) {
                ...
                for (int i = 0; i < fcount; i++) {
                    TextView textView = new TextView(edu.aku.hassannaqvi.foodfortificationsurvey.ui.SyncActivity.this);
                    ...
                    handler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            WorkManager.getInstance(SyncActivity.this).getWorkInfoByIdLiveData(photoUpload.getId())
                                    .observe(edu.aku.hassannaqvi.foodfortificationsurvey.ui.SyncActivity.this, new Observer<WorkInfo>() {
                                        ...
                                        public void onChanged(@Nullable WorkInfo workInfo) {
                                            ...
                                            if (workInfo.getState() == WorkInfo.State.FAILED) {
                                                Toast.makeText(edu.aku.hassannaqvi.foodfortificationsurvey.ui.SyncActivity.this, "Failed", Toast.LENGTH_SHORT).show();
