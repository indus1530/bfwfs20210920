...
import static edu.aku.hassannaqvi.foodfortificationsurvey.database.CreateTable.SQL_CREATE_ANTHRO;
import static edu.aku.hassannaqvi.foodfortificationsurvey.database.CreateTable.SQL_CREATE_CHILDLIST;
import static edu.aku.hassannaqvi.foodfortificationsurvey.database.CreateTable.SQL_CREATE_CLUSTERS;
import static edu.aku.hassannaqvi.foodfortificationsurvey.database.CreateTable.SQL_CREATE_FORMS;
import static edu.aku.hassannaqvi.foodfortificationsurvey.database.CreateTable.SQL_CREATE_MWRALIST;
import static edu.aku.hassannaqvi.foodfortificationsurvey.database.CreateTable.SQL_CREATE_PREGNANCY;
import static edu.aku.hassannaqvi.foodfortificationsurvey.database.CreateTable.SQL_CREATE_RANDOM;
import static edu.aku.hassannaqvi.foodfortificationsurvey.database.CreateTable.SQL_CREATE_SAMPLES;
import static edu.aku.hassannaqvi.foodfortificationsurvey.database.CreateTable.SQL_CREATE_USERS;
import static edu.aku.hassannaqvi.foodfortificationsurvey.database.CreateTable.SQL_CREATE_VERSIONAPP;
import static edu.aku.hassannaqvi.foodfortificationsurvey.database.CreateTable.SQL_CREATE_ZSTANDARD;
...
import edu.aku.hassannaqvi.foodfortificationsurvey.contracts.TableContracts.BloodTable;
...
import edu.aku.hassannaqvi.foodfortificationsurvey.contracts.TableContracts.StoolTable;
...
import edu.aku.hassannaqvi.foodfortificationsurvey.contracts.TableContracts.ZScoreTable;
...
import edu.aku.hassannaqvi.foodfortificationsurvey.models.Clusters;
...
import edu.aku.hassannaqvi.foodfortificationsurvey.models.VersionApp;
import edu.aku.hassannaqvi.foodfortificationsurvey.models.ZStandard;
...
//        String[] whereArgs = new String[]{"%" + spDateT.substring(0, 8).trim() + "%"};
    ...
    public String getWraName(String uid) throws JSONException {
        ...
        try {
            ...
            while (c.moveToNext()) {
                form = new Form();
                form.sF3Hydrate(c.getString(c.getColumnIndex(FormsTable.COLUMN_SF3)));
