...
import edu.aku.hassannaqvi.foodfortificationsurvey.databinding.ActivitySectionE1Binding;
...
public class SectionE1Activity extends AppCompatActivity {
    ...
    private boolean updateDB() {
        ...
        long updcount = 0;
        try {
            updcount = db.updatesFormColumn(TableContracts.FormsTable.COLUMN_SE1, form.sE1toString());
