...
import edu.aku.hassannaqvi.foodfortificationsurvey.databinding.ActivitySectionG3Binding;
...
public class SectionG3Activity extends AppCompatActivity {
    ...
    private boolean updateDB() {
        ...
        long updcount = 0;
        try {
            updcount = db.updatesFoodConsumptionColumn(TableContracts.FoodConsumptionTable.COLUMN_SG3, MainApp.foodConsumption.get(MainApp.foodIndex).sG3toString());
