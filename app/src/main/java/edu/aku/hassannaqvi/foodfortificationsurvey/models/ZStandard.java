...
//    String REGION_DSS;
    ...
    public edu.aku.hassannaqvi.foodfortificationsurvey.models.ZStandard Sync(JSONObject jsonObject) throws JSONException {
...
//        this.REGION_DSS = jsonObject.getString(singleUser.REGION_DSS);
    ...
    public edu.aku.hassannaqvi.foodfortificationsurvey.models.ZStandard Hydrate(Cursor cursor) {
