...
import edu.aku.hassannaqvi.foodfortificationsurvey.databinding.ActivitySectionG2Binding;
...
public class SectionG2Activity extends AppCompatActivity {
    ...
    private boolean updateDB() {
        ...
        long updcount = 0;
        try {
            updcount = db.updatesFoodConsumptionColumn(TableContracts.FoodConsumptionTable.COLUMN_SG2, MainApp.foodConsumption.get(MainApp.foodIndex).sG2toString());
