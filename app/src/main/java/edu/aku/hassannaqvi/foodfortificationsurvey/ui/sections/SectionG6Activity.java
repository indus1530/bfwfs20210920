...
import edu.aku.hassannaqvi.foodfortificationsurvey.databinding.ActivitySectionG6Binding;
import edu.aku.hassannaqvi.foodfortificationsurvey.ui.EndingActivity;


public class SectionG6Activity extends AppCompatActivity {
    private static final String TAG = "SectionG6Activity";
    ActivitySectionG6Binding bi;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bi = DataBindingUtil.setContentView(this, R.layout.activity_section_g6);
        bi.setCallback(this);
    ...
    private boolean updateDB() {
        ...
        long updcount = 0;
        try {
            updcount = db.updatesFoodConsumptionColumn(TableContracts.FoodConsumptionTable.COLUMN_SG6, MainApp.foodConsumption.get(MainApp.foodIndex).sG6toString());
