...
import edu.aku.hassannaqvi.foodfortificationsurvey.databinding.ActivitySectionD1Binding;
...
public class SectionD1Activity extends AppCompatActivity {
    ...
    private boolean updateDB() {
        ...
        long updcount = 0;
        try {
            updcount = db.updatesFormColumn(TableContracts.FormsTable.COLUMN_SD1, form.sD1toString());
