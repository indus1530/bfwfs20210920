package edu.aku.hassannaqvi.bfwfs20210920.ui;

import static edu.aku.hassannaqvi.bfwfs20210920.core.MainApp.PROJECT_NAME;
import static edu.aku.hassannaqvi.bfwfs20210920.core.MainApp.sdDir;
import static edu.aku.hassannaqvi.bfwfs20210920.core.MainApp.uploadData;
import static edu.aku.hassannaqvi.bfwfs20210920.utils.AndroidUtilityKt.isNetworkConnected;
...
import edu.aku.hassannaqvi.bfwfs20210920.adapters.SyncListAdapter;
...
import edu.aku.hassannaqvi.bfwfs20210920.databinding.ActivitySyncBinding;
import edu.aku.hassannaqvi.bfwfs20210920.models.SyncModel;
import edu.aku.hassannaqvi.bfwfs20210920.workers.DataDownWorkerALL;
import edu.aku.hassannaqvi.bfwfs20210920.workers.DataUpWorkerALL;
import edu.aku.hassannaqvi.bfwfs20210920.workers.PhotoUploadWorker2;
import edu.aku.hassannaqvi.bfwfs20210920.workers.ReadJSONWorker;
        ...
        if (sdDir.exists()) {
            ...
            if (files.length > 0) {
                ...
                for (int i = 0; i < fcount; i++) {
                    TextView textView = new TextView(edu.aku.hassannaqvi.bfwfs20210920.ui.SyncActivity.this);
                    ...
                    handler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            WorkManager.getInstance(SyncActivity.this).getWorkInfoByIdLiveData(photoUpload.getId())
                                    .observe(edu.aku.hassannaqvi.bfwfs20210920.ui.SyncActivity.this, new Observer<WorkInfo>() {
                                        ...
                                        public void onChanged(@Nullable WorkInfo workInfo) {
                                            ...
                                            if (workInfo.getState() == WorkInfo.State.FAILED) {
                                                Toast.makeText(edu.aku.hassannaqvi.bfwfs20210920.ui.SyncActivity.this, "Failed", Toast.LENGTH_SHORT).show();
