...
//    String REGION_DSS;
    ...
    public edu.aku.hassannaqvi.bfwfs20210920.models.ZStandard Sync(JSONObject jsonObject) throws JSONException {
...
//        this.REGION_DSS = jsonObject.getString(singleUser.REGION_DSS);
    ...
    public edu.aku.hassannaqvi.bfwfs20210920.models.ZStandard Hydrate(Cursor cursor) {
