...
import static edu.aku.hassannaqvi.bfwfs20210920.core.MainApp.TAJIKISTAN;
import static edu.aku.hassannaqvi.bfwfs20210920.core.MainApp.sharedPref;
import static edu.aku.hassannaqvi.bfwfs20210920.database.CreateTable.DATABASE_COPY;
...
import edu.aku.hassannaqvi.bfwfs20210920.MainActivity;
import edu.aku.hassannaqvi.bfwfs20210920.R;
import edu.aku.hassannaqvi.bfwfs20210920.core.AppInfo;
import edu.aku.hassannaqvi.bfwfs20210920.core.MainApp;
import edu.aku.hassannaqvi.bfwfs20210920.database.DatabaseHelper;
import edu.aku.hassannaqvi.bfwfs20210920.databinding.ActivityLoginBinding;
...
*//*
    ...
    public void onSyncDataClick(View view) {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            startActivity(new Intent(this, edu.aku.hassannaqvi.bfwfs20210920.ui.SyncActivity.class).putExtra("login", true));
        } else {
    ...
    public void attemptLogin(View view) {
        ...
        if (attemptCounter == 7) {
            Intent iLogin = new Intent(edu.aku.hassannaqvi.bfwfs20210920.ui.LoginActivity.this, MainActivity.class);
            ...
            if ((username.equals("dmu@aku") && password.equals("aku?dmu"))
                ...
                Toast.makeText(edu.aku.hassannaqvi.bfwfs20210920.ui.LoginActivity.this, username + " " + password, Toast.LENGTH_SHORT).show();
            }
